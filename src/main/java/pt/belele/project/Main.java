...
public class Main {
	...
	public static void main(String[] args) {
		...
		List<String[]> list = CSVReader.readFromCSV("http://www.football-data.co.uk/mmz4281/1516/P1.csv");
		...
		for (String[] arr : list) {
			...
			Fixture fixture = fixtureController.createFixture(new Date(arr[1]), s, t1, t2);
			resultController.createResult(fixture, arr[4], arr[5], arr[7], arr[8]);
